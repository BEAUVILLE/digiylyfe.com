...
(function(){
  ...
  var I18N={
    fr:{title:'PRÉCISER MON ACTIVITÉ ET MON PROJET',hint:'Facultatif · pour nous donner tout ce qu’il faut sans multiplier les messages WhatsApp.',info:'Votre activité peut être principale ou exercée à côté d’un autre emploi. Indiquez simplement vos vrais créneaux : DIGIYLYFE est ouvert aux activités principales comme complémentaires.',module:'Module lié à votre activité *',moduleHelp:'La carte reste gratuite. Choisissez le module qui correspond à votre activité. Si vous hésitez, choisissez « Autre / à définir ».',hours:'Horaires d’activité / disponibilités',hoursPh:'Ex. lun–ven 18h–22h · samedi toute la journée · sur rendez-vous',site:'Lien de votre site web, si vous en avez un',sitePh:'https://monsite.com',social:'Réseaux et autres liens',socialPh:'Google Business, Facebook, Instagram, TikTok…',summary:'Présentez votre activité en quelques mots',summaryPh:'Ce que vous faites, pour qui, vos spécialités et votre zone d’intervention…',details:'Informations utiles pour préparer votre module',detailsBase:'Tout renseignement qui nous évitera de vous le redemander ensuite.',logo:'Votre logo, si vous en possédez un',logoHelp:'Facultatif · PNG, JPG, WEBP, SVG ou PDF · 5 Mo maximum. Le fichier reste privé dans votre dossier et n’est pas publié automatiquement.',saving:'Enregistrement du dossier…',saved:'Demande enregistrée. Nous avons bien votre dossier.',error:'Impossible d’enregistrer pour le moment. Vérifiez votre connexion et réessayez.',logoError:'Logo trop lourd ou format non accepté. PNG, JPG, WEBP, SVG ou PDF · 5 Mo maximum.',modules:['— Choisissez le module lié à votre activité —','Carte gratuite seulement','DIGIY PRO · fiche professionnelle','DIGIY LOC','DIGIY DRIVER','DIGIY RESA','MON RESTO','MON COMMERCE','PRO CARNET','Autre / à définir'],detailMap:{'LOC':'Nombre d’unités, type d’hébergement, services proposés…','DRIVER':'Type de véhicule, capacité, zones et horaires de disponibilité…','RESA':'Type de réservation, capacité, services, créneaux…','MON RESTO':'Type de cuisine, nombre de places, horaires, livraison / emporter…','MON COMMERCE':'Produits, catégories, livraison, zone desservie…','CARNET':'Type d’activité, organisation clients, besoins de suivi…','DIGIY PRO':'Services principaux, clientèle visée, particularités de votre activité…'}},
    en:{title:'TELL US MORE ABOUT YOUR ACTIVITY AND PROJECT',hint:'Optional · give us what we need without long WhatsApp exchanges.',info:'Your activity may be full-time or alongside another job. Simply tell us when you are really available: DIGIYLYFE welcomes both main and side activities.',module:'Module linked to your activity *',moduleHelp:'The card stays free. Choose the module that fits your activity. If unsure, choose Other / to be defined.',hours:'Business hours / availability',hoursPh:'e.g. Mon–Fri 6pm–10pm · all day Saturday · by appointment',site:'Your website link, if you have one',sitePh:'https://mywebsite.com',social:'Social media and other links',socialPh:'Google Business, Facebook, Instagram, TikTok…',summary:'Describe your activity briefly',summaryPh:'What you do, for whom, specialties and service area…',details:'Useful details for your module',detailsBase:'Anything that saves us from asking you again later.',logo:'Your logo, if you have one',logoHelp:'Optional · PNG, JPG, WEBP, SVG or PDF · max 5 MB. The file stays private in your request and is not published automatically.',saving:'Saving your file…',saved:'Request saved. We have received your file.',error:'Unable to save right now. Check your connection and try again.',logoError:'Logo is too large or its format is not accepted. PNG, JPG, WEBP, SVG or PDF · max 5 MB.',modules:['— Choose the module linked to your activity —','Free card only','DIGIY PRO · professional profile','DIGIY LOC','DIGIY DRIVER','DIGIY RESA','MON RESTO','MON COMMERCE','PRO CARNET','Other / to be defined']},
    es:{title:'PRECISAR MI ACTIVIDAD Y MI PROYECTO',hint:'Opcional · para evitar largos intercambios por WhatsApp.',info:'La actividad puede ser principal o complementaria a otro empleo. Indique simplemente sus horarios reales de disponibilidad.',module:'Módulo relacionado con su actividad *',moduleHelp:'La tarjeta sigue siendo gratuita. Elija el módulo que corresponde a su actividad.',hours:'Horarios / disponibilidad',hoursPh:'Ej. lun–vie 18h–22h · sábado todo el día · con cita',site:'Enlace de su sitio web, si tiene uno',sitePh:'https://misitio.com',social:'Redes y otros enlaces',socialPh:'Google Business, Facebook, Instagram, TikTok…',summary:'Presente brevemente su actividad',summaryPh:'Qué hace, para quién, especialidades y zona…',details:'Datos útiles para preparar el módulo',detailsBase:'Todo lo que evite tener que preguntárselo después.',logo:'Su logotipo, si dispone de uno',logoHelp:'Opcional · PNG, JPG, WEBP, SVG o PDF · máximo 5 MB. El archivo queda privado en su dossier.',saving:'Guardando el dossier…',saved:'Solicitud registrada. Hemos recibido su dossier.',error:'No se puede guardar ahora. Compruebe su conexión e inténtelo de nuevo.',logoError:'Logo demasiado grande o formato no aceptado. PNG, JPG, WEBP, SVG o PDF · máximo 5 MB.',modules:['— Elija el módulo relacionado con su actividad —','Solo tarjeta gratuita','DIGIY PRO · ficha profesional','DIGIY LOC','DIGIY DRIVER','DIGIY RESA','MON RESTO','MON COMMERCE','PRO CARNET','Otro / por definir']},
    pt:{title:'DETALHAR A MINHA ATIVIDADE E PROJETO',hint:'Opcional · para evitar longas trocas no WhatsApp.',info:'A atividade pode ser principal ou complementar a outro emprego. Indique apenas os horários em que está realmente disponível.',module:'Módulo ligado à sua atividade *',moduleHelp:'O cartão continua gratuito. Escolha o módulo que corresponde à sua atividade.',hours:'Horários / disponibilidade',hoursPh:'Ex. seg–sex 18h–22h · sábado todo o dia · por marcação',site:'Ligação do seu site, se tiver',sitePh:'https://meusite.com',social:'Redes sociais e outras ligações',socialPh:'Google Business, Facebook, Instagram, TikTok…',summary:'Apresente brevemente a atividade',summaryPh:'O que faz, para quem, especialidades e zona…',details:'Informações úteis para o módulo',detailsBase:'Tudo o que evite termos de perguntar novamente.',logo:'O seu logótipo, se tiver',logoHelp:'Opcional · PNG, JPG, WEBP, SVG ou PDF · máximo 5 MB. O ficheiro fica privado no seu processo.',saving:'A guardar o processo…',saved:'Pedido registado. Recebemos o seu processo.',error:'Não foi possível guardar agora. Verifique a ligação e tente novamente.',logoError:'Logótipo demasiado grande ou formato não aceite. PNG, JPG, WEBP, SVG ou PDF · máximo 5 MB.',modules:['— Escolha o módulo ligado à sua atividade —','Apenas cartão gratuito','DIGIY PRO · ficha profissional','DIGIY LOC','DIGIY DRIVER','DIGIY RESA','MON RESTO','MON COMMERCE','PRO CARNET','Outro / a definir']},
    it:{title:'PRECISARE ATTIVITÀ E PROGETTO',hint:'Facoltativo · per evitare lunghi scambi su WhatsApp.',info:'L’attività può essere principale o svolta accanto a un altro lavoro. Indicate semplicemente quando siete realmente disponibili.',module:'Modulo legato alla vostra attività *',moduleHelp:'La carta resta gratuita. Scegliete il modulo che corrisponde alla vostra attività.',hours:'Orari / disponibilità',hoursPh:'Es. lun–ven 18–22 · sabato tutto il giorno · su appuntamento',site:'Link del vostro sito, se disponibile',sitePh:'https://miosito.com',social:'Social e altri link',socialPh:'Google Business, Facebook, Instagram, TikTok…',summary:'Presentate brevemente l’attività',summaryPh:'Cosa fate, per chi, specialità e zona…',details:'Informazioni utili per il modulo',detailsBase:'Tutto ciò che evita di dovervelo richiedere dopo.',logo:'Il vostro logo, se disponibile',logoHelp:'Facoltativo · PNG, JPG, WEBP, SVG o PDF · max 5 MB. Il file resta privato nel dossier.',saving:'Registrazione del dossier…',saved:'Richiesta registrata. Abbiamo ricevuto il dossier.',error:'Impossibile salvare ora. Controllate la connessione e riprovate.',logoError:'Logo troppo grande o formato non accettato. PNG, JPG, WEBP, SVG o PDF · max 5 MB.',modules:['— Scegliete il modulo legato alla vostra attività —','Solo carta gratuita','DIGIY PRO · scheda professionale','DIGIY LOC','DIGIY DRIVER','DIGIY RESA','MON RESTO','MON COMMERCE','PRO CARNET','Altro / da definire']},
    de:{title:'TÄTIGKEIT UND PROJEKT PRÄZISIEREN',hint:'Optional · damit lange WhatsApp-Nachfragen entfallen.',info:'Die Tätigkeit kann hauptberuflich oder neben einem anderen Job ausgeübt werden. Geben Sie einfach Ihre tatsächlichen verfügbaren Zeiten an.',module:'Modul für Ihre Tätigkeit *',moduleHelp:'Die Karte bleibt kostenlos. Wählen Sie das Modul, das zu Ihrer Tätigkeit passt.',hours:'Öffnungszeiten / Verfügbarkeit',hoursPh:'z. B. Mo–Fr 18–22 Uhr · Samstag ganztägig · nach Termin',site:'Link zu Ihrer Website, falls vorhanden',sitePh:'https://meinewebsite.de',social:'Social Media und weitere Links',socialPh:'Google Business, Facebook, Instagram, TikTok…',summary:'Tätigkeit kurz beschreiben',summaryPh:'Was Sie tun, für wen, Spezialitäten und Gebiet…',details:'Nützliche Angaben für das Modul',detailsBase:'Alles, was spätere Rückfragen vermeidet.',logo:'Ihr Logo, falls vorhanden',logoHelp:'Optional · PNG, JPG, WEBP, SVG oder PDF · max. 5 MB. Die Datei bleibt privat im Dossier.',saving:'Dossier wird gespeichert…',saved:'Anfrage gespeichert. Ihr Dossier ist eingegangen.',error:'Speichern derzeit nicht möglich. Verbindung prüfen und erneut versuchen.',logoError:'Logo zu groß oder Format nicht akzeptiert. PNG, JPG, WEBP, SVG oder PDF · max. 5 MB.',modules:['— Wählen Sie das Modul für Ihre Tätigkeit —','Nur kostenlose Karte','DIGIY PRO · Profi-Profil','DIGIY LOC','DIGIY DRIVER','DIGIY RESA','MON RESTO','MON COMMERCE','PRO CARNET','Andere / noch offen']},
    nl:{title:'MIJN ACTIVITEIT EN PROJECT VERDUIDELIJKEN',hint:'Optioneel · om lange WhatsApp-uitwisselingen te vermijden.',info:'De activiteit kan hoofdberoep zijn of naast een andere baan bestaan. Geef gewoon aan wanneer u werkelijk beschikbaar bent.',module:'Module voor uw activiteit *',moduleHelp:'De kaart blijft gratis. Kies de module die bij uw activiteit past.',hours:'Openingstijden / beschikbaarheid',hoursPh:'Bijv. ma–vr 18–22 u · zaterdag hele dag · op afspraak',site:'Link naar uw website, indien aanwezig',sitePh:'https://mijnsite.nl',social:'Social media en andere links',socialPh:'Google Business, Facebook, Instagram, TikTok…',summary:'Beschrijf uw activiteit kort',summaryPh:'Wat u doet, voor wie, specialiteiten en gebied…',details:'Nuttige informatie voor de module',detailsBase:'Alles wat latere vragen overbodig maakt.',logo:'Uw logo, als u er een hebt',logoHelp:'Optioneel · PNG, JPG, WEBP, SVG of PDF · max. 5 MB. Het bestand blijft privé in uw dossier.',saving:'Dossier opslaan…',saved:'Aanvraag opgeslagen. Wij hebben uw dossier ontvangen.',error:'Opslaan lukt nu niet. Controleer uw verbinding en probeer opnieuw.',logoError:'Logo te groot of formaat niet geaccepteerd. PNG, JPG, WEBP, SVG of PDF · max. 5 MB.',modules:['— Kies de module die bij uw activiteit hoort —','Alleen gratis kaart','DIGIY PRO · professioneel profiel','DIGIY LOC','DIGIY DRIVER','DIGIY RESA','MON RESTO','MON COMMERCE','PRO CARNET','Andere / nog te bepalen']},
    ar:{title:'تفاصيل النشاط والمشروع',hint:'اختياري · لتجنب كثرة الرسائل على واتساب.',info:'يمكن أن يكون النشاط عملاً رئيسياً أو نشاطاً إضافياً إلى جانب وظيفة أخرى. اذكر فقط الأوقات التي تكون فيها متاحاً فعلاً.',module:'الوحدة المرتبطة بنشاطك *',moduleHelp:'تبقى البطاقة مجانية. اختر الوحدة التي تناسب نشاطك.',hours:'ساعات النشاط / التوفر',hoursPh:'مثال: الاثنين–الجمعة 18–22 · السبت طوال اليوم · حسب الموعد',site:'رابط موقعك إن وجد',sitePh:'https://mysite.com',social:'الشبكات والروابط الأخرى',socialPh:'Google Business, Facebook, Instagram, TikTok…',summary:'عرّف نشاطك باختصار',summaryPh:'ماذا تقدم، لمن، تخصصاتك ومنطقة عملك…',details:'معلومات مفيدة لإعداد الوحدة',detailsBase:'أي معلومة توفر علينا سؤالك عنها لاحقاً.',logo:'شعارك إن كان لديك',logoHelp:'اختياري · PNG أو JPG أو WEBP أو SVG أو PDF · بحد أقصى 5 ميغابايت. يبقى الملف خاصاً داخل طلبك.',saving:'جارٍ تسجيل الملف…',saved:'تم تسجيل الطلب واستلام ملفك.',error:'تعذر التسجيل الآن. تحقق من الاتصال وحاول مرة أخرى.',logoError:'الشعار كبير جداً أو الصيغة غير مقبولة. الحد الأقصى 5 ميغابايت.',modules:['— اختر الوحدة المرتبطة بنشاطك —','البطاقة المجانية فقط','DIGIY PRO · الملف المهني','DIGIY LOC','DIGIY DRIVER','DIGIY RESA','MON RESTO','MON COMMERCE','PRO CARNET','آخر / يحدد لاحقاً']}
  };
  ...
  function refresh(){
    ...
    var old=module.value;module.innerHTML='';values.forEach(function(v,i){if(v==='CARTE GRATUITE')return;var o=document.createElement('option');o.value=v;o.textContent=(d.modules&&d.modules[i])||I18N.fr.modules[i];module.appendChild(o)});module.required=true;module.value=old;
    detailHint();
  }
