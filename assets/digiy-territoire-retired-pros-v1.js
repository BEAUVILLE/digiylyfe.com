...
function loadFavoris(){if(window.DIGIY_TERRITOIRE_FAVORIS_V1||document.querySelector('script[data-digiy-territoire-favoris]'))return;var s=document.createElement('script');s.src='/assets/digiy-territoire-favoris-v1.js?v=20260904-v1';s.defer=true;s.setAttribute('data-digiy-territoire-favoris','1');document.head.appendChild(s)}
