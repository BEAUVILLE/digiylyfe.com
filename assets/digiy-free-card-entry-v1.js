...
(function(){
  ...
  function style(){
    ...
    s.textContent='.digiyFreeCardEntry{margin:0 0 14px;padding:18px;border:2px solid rgba(246,196,83,.72);border-radius:26px;background:linear-gradient(145deg,rgba(246,196,83,.16),rgba(45,212,191,.11),rgba(255,255,255,.045));box-shadow:0 18px 44px rgba(0,0,0,.24);text-align:center;color:#fffaf0}.digiyFreeCardEntry .freeMini{display:inline-flex;padding:6px 10px;border-radius:999px;border:1px solid rgba(45,212,191,.52);background:rgba(45,212,191,.09);color:#c9fff7;font-size:9.5px;font-weight:1000;letter-spacing:.07em;text-transform:uppercase}.digiyFreeCardEntry h2{margin:10px auto 0;max-width:760px;font-size:clamp(24px,5vw,36px);line-height:1.03;font-weight:1000;letter-spacing:-.03em}.digiyFreeCardEntry p{margin:9px auto 0;max-width:790px;color:#dce9e3;font-size:12px;line-height:1.5;font-weight:850}.digiyFreeCardEntry .freeCta{display:flex;align-items:center;justify-content:center;width:min(100%,540px);min-height:56px;margin:14px auto 0;padding:12px 17px;border-radius:999px;background:linear-gradient(135deg,#fff1bd,#f6c453,#22c55e);color:#06140f;border:1px solid rgba(255,241,189,.80);font-size:12px;line-height:1.2;font-weight:1000;box-shadow:0 12px 28px rgba(0,0,0,.24);text-decoration:none}.digiyFreeCardEntry[dir="rtl"]{direction:rtl}.digiyStoryEntry{position:relative;overflow:hidden;margin:14px 0;padding:18px;border:1px solid rgba(246,196,83,.62);border-radius:26px;background:radial-gradient(480px 220px at 0 0,rgba(246,196,83,.15),transparent 68%),linear-gradient(145deg,rgba(8,73,50,.98),rgba(4,31,24,.98) 66%,rgba(10,76,70,.78));box-shadow:0 18px 44px rgba(0,0,0,.24);text-align:center;color:#fffaf0}.digiyStoryEntry .storyMini{display:inline-flex;padding:6px 10px;border-radius:999px;border:1px solid rgba(45,212,191,.52);background:rgba(45,212,191,.09);color:#c9fff7;font-size:9.5px;font-weight:1000;letter-spacing:.07em;text-transform:uppercase}.digiyStoryEntry h2{margin:10px auto 0;max-width:760px;font-size:clamp(24px,5vw,35px);line-height:1.03;font-weight:1000;letter-spacing:-.03em}.digiyStoryEntry p{margin:9px auto 0;max-width:720px;color:#dce9e3;font-size:12px;line-height:1.5;font-weight:850}.digiyStoryEntry .storyFlow{display:flex;align-items:center;justify-content:center;gap:8px;margin:15px auto 0;flex-wrap:wrap}.digiyStoryEntry .storyNode{min-width:72px;padding:9px 11px;border-radius:16px;border:1px solid rgba(255,255,255,.15);background:rgba(255,255,255,.06);font-size:22px;box-shadow:inset 0 0 0 1px rgba(255,255,255,.02)}.digiyStoryEntry .storyArrow{color:#f6c453;font-size:20px;font-weight:1000}.digiyStoryEntry .storyCta{display:flex;align-items:center;justify-content:center;width:min(100%,520px);min-height:54px;margin:15px auto 0;padding:12px 17px;border-radius:999px;background:linear-gradient(135deg,#fff1bd,#f6c453,#22c55e);color:#06140f;border:1px solid rgba(255,241,189,.80);font-size:12px;line-height:1.2;font-weight:1000;box-shadow:0 12px 28px rgba(0,0,0,.24);text-decoration:none}.digiyStoryEntry[dir="rtl"]{direction:rtl}@media(max-width:420px){.digiyStoryEntry{padding:16px 12px}.digiyStoryEntry .storyNode{min-width:64px}.digiyStoryEntry .storyFlow{gap:6px}}';
  ...
  function mountStory(){
    ...
    var anchor=document.querySelector('.ownerModules');
    if(anchor)anchor.insertAdjacentElement('afterend',box);else{var fallback=document.getElementById('digiyEntryChoice');if(fallback)fallback.insertAdjacentElement('afterend',box);else{var m=document.querySelector('main');if(m)m.appendChild(box)}}
    renderStory(box);
    document.querySelectorAll('.langBtn').forEach(function(b){b.addEventListener('click',function(){setTimeout(function(){renderStory(box)},20)})});
  }
  function boot(){mount();mountStory();}
