...
const COPY={
  fr:{title:'Vos tarifs indicatifs · facultatif',lead:'Souhaitez-vous afficher quelques tarifs sur votre carte ?',toggle:'Je souhaite afficher mes tarifs',label:'Service / prestation',price:'Prix',example:'Ex. Coupe femme, dépannage, shooting photo, Saly → AIBD',note:'Ces tarifs seront affichés comme vos propres tarifs professionnels. Vous pourrez demander leur modification à DIGIYLYFE.',partial:'Complétez le service ou la prestation et le prix pour chaque tarif renseigné.'},
  en:{title:'Your indicative prices · optional',lead:'Would you like to display a few prices on your card?',toggle:'I want to display my prices',label:'Service / offering',price:'Price',example:'e.g. Haircut, repair, photo shoot, Saly → AIBD',note:'These prices will be displayed as your own professional prices. You can ask DIGIYLYFE to update them.',partial:'Complete both the service or offering and the price for each price entered.'},
  es:{title:'Sus tarifas indicativas · opcional',lead:'¿Desea mostrar algunas tarifas en su tarjeta?',toggle:'Quiero mostrar mis tarifas',label:'Servicio / prestación',price:'Precio',example:'Ej. Corte, reparación, sesión de fotos, Saly → AIBD',note:'Estas tarifas se mostrarán como sus propias tarifas profesionales. Podrá solicitar su modificación a DIGIYLYFE.',partial:'Complete el servicio o la prestación y el precio de cada tarifa indicada.'},
  pt:{title:'Os seus preços indicativos · opcional',lead:'Quer mostrar alguns preços no seu cartão?',toggle:'Quero mostrar os meus preços',label:'Serviço / prestação',price:'Preço',example:'Ex. Corte, reparação, sessão fotográfica, Saly → AIBD',note:'Estes preços serão apresentados como os seus próprios preços profissionais. Pode pedir à DIGIYLYFE para os alterar.',partial:'Preencha o serviço ou a prestação e o preço para cada valor indicado.'},
  it:{title:'Le tue tariffe indicative · facoltativo',lead:'Vuoi mostrare alcune tariffe sulla tua carta?',toggle:'Voglio mostrare le mie tariffe',label:'Servizio / prestazione',price:'Prezzo',example:'Es. Taglio, riparazione, servizio fotografico, Saly → AIBD',note:'Queste tariffe saranno mostrate come le tue tariffe professionali. Potrai chiederne la modifica a DIGIYLYFE.',partial:'Completa servizio o prestazione e prezzo per ogni tariffa inserita.'},
  de:{title:'Ihre Richtpreise · optional',lead:'Möchten Sie einige Preise auf Ihrer Karte anzeigen?',toggle:'Ich möchte meine Preise anzeigen',label:'Leistung / Angebot',price:'Preis',example:'z. B. Haarschnitt, Reparatur, Fotoshooting, Saly → AIBD',note:'Diese Preise werden als Ihre eigenen professionellen Preise angezeigt. Änderungen können Sie bei DIGIYLYFE anfragen.',partial:'Bitte Leistung oder Angebot und Preis für jeden eingetragenen Preis ausfüllen.'},
  nl:{title:'Uw indicatieve prijzen · optioneel',lead:'Wilt u enkele prijzen op uw kaart tonen?',toggle:'Ik wil mijn prijzen tonen',label:'Dienst / prestatie',price:'Prijs',example:'Bijv. knippen, reparatie, fotoshoot, Saly → AIBD',note:'Deze prijzen worden als uw eigen professionele prijzen weergegeven. U kunt DIGIYLYFE vragen ze aan te passen.',partial:'Vul voor elke ingevoerde prijs zowel de dienst of prestatie als de prijs in.'},
  ar:{title:'أسعارك الإرشادية · اختياري',lead:'هل تريد عرض بعض الأسعار على بطاقتك؟',toggle:'أرغب في عرض أسعاري',label:'الخدمة / العرض',price:'السعر',example:'مثال: قص الشعر، إصلاح، جلسة تصوير، Saly → AIBD',note:'ستظهر هذه الأسعار باعتبارها أسعارك المهنية الخاصة. ويمكنك طلب تعديلها من DIGIYLYFE.',partial:'أكمل الخدمة أو العرض والسعر لكل تعرفة تم إدخالها.'}
};
...
function render(){
  ...
  document.querySelectorAll('.digiy-tariff-name').forEach(el=>el.placeholder=t.example);
