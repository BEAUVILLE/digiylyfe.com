...
(function(){
  ...
  function renameWorldHub(){
    ...
    var copy={
      fr:{title:'DIGIYLYFE · DU LOCAL AU MONDE',lead:'Un même CORE. Des territoires différents. Le professionnel reste local.',intro:'Cinq portes réelles montrent aujourd’hui l’ouverture de DIGIYLYFE : Sénégal · Petite Côte et Dakar ; France · Vallée de la Dordogne et Bordeaux ; États-Unis · Miami. Choisissez votre territoire, puis votre besoin et votre zone.',path:'Pays → Territoire → Zone → Besoin → Professionnel → OUVRIR',dordogneTitle:'DIGIY PÉRIGORD · VALLÉE DE LA DORDOGNE',dordogneZones:'Sarlat-la-Canéda · Périgord · Vallée de la Dordogne',aria:'DIGIYLYFE du local au monde'},
      en:{title:'DIGIYLYFE · FROM LOCAL TO THE WORLD',lead:'One CORE. Different territories. The professional stays local.',intro:'Five real doors now show DIGIYLYFE’s reach: Senegal · Petite Côte and Dakar; France · Dordogne Valley and Bordeaux; United States · Miami. Choose your territory, then your need and local area.',path:'Country → Territory → Area → Need → Professional → OPEN',dordogneTitle:'DIGIY PÉRIGORD · DORDOGNE VALLEY',dordogneZones:'Sarlat-la-Canéda · Périgord · Dordogne Valley',aria:'DIGIYLYFE from local to the world'},
      es:{title:'DIGIYLYFE · DE LO LOCAL AL MUNDO',lead:'Un mismo CORE. Territorios diferentes. El profesional sigue siendo local.',intro:'Cinco puertas reales muestran hoy la apertura de DIGIYLYFE: Senegal · Petite Côte y Dakar; Francia · Valle del Dordoña y Burdeos; Estados Unidos · Miami. Elija su territorio, después su necesidad y su zona.',path:'País → Territorio → Zona → Necesidad → Profesional → ABRIR',dordogneTitle:'DIGIY PÉRIGORD · VALLE DEL DORDOÑA',dordogneZones:'Sarlat-la-Canéda · Périgord · Valle del Dordoña',aria:'DIGIYLYFE de lo local al mundo'},
      pt:{title:'DIGIYLYFE · DO LOCAL AO MUNDO',lead:'Um único CORE. Territórios diferentes. O profissional permanece local.',intro:'Cinco portas reais mostram hoje a abertura da DIGIYLYFE: Senegal · Petite Côte e Dakar; França · Vale da Dordogne e Bordéus; Estados Unidos · Miami. Escolha o território, depois a necessidade e a zona.',path:'País → Território → Zona → Necessidade → Profissional → ABRIR',dordogneTitle:'DIGIY PÉRIGORD · VALE DA DORDOGNE',dordogneZones:'Sarlat-la-Canéda · Périgord · Vale da Dordogne',aria:'DIGIYLYFE do local ao mundo'},
      it:{title:'DIGIYLYFE · DAL LOCALE AL MONDO',lead:'Un solo CORE. Territori diversi. Il professionista resta locale.',intro:'Cinque porte reali mostrano oggi l’apertura di DIGIYLYFE: Senegal · Petite Côte e Dakar; Francia · Valle della Dordogna e Bordeaux; Stati Uniti · Miami. Scegli il territorio, poi il bisogno e la zona.',path:'Paese → Territorio → Zona → Bisogno → Professionista → APRI',dordogneTitle:'DIGIY PÉRIGORD · VALLE DELLA DORDOGNA',dordogneZones:'Sarlat-la-Canéda · Périgord · Valle della Dordogna',aria:'DIGIYLYFE dal locale al mondo'},
      de:{title:'DIGIYLYFE · VOM LOKALEN IN DIE WELT',lead:'Ein CORE. Unterschiedliche Gebiete. Der Profi bleibt lokal.',intro:'Fünf reale Türen zeigen heute die Reichweite von DIGIYLYFE: Senegal · Petite Côte und Dakar; Frankreich · Dordogne-Tal und Bordeaux; Vereinigte Staaten · Miami. Wählen Sie Ihr Gebiet, dann Bedarf und Zone.',path:'Land → Gebiet → Zone → Bedarf → Profi → ÖFFNEN',dordogneTitle:'DIGIY PÉRIGORD · DORDOGNE-TAL',dordogneZones:'Sarlat-la-Canéda · Périgord · Dordogne-Tal',aria:'DIGIYLYFE vom Lokalen in die Welt'},
      nl:{title:'DIGIYLYFE · VAN LOKAAL NAAR DE WERELD',lead:'Eén CORE. Verschillende gebieden. De professional blijft lokaal.',intro:'Vijf echte ingangen tonen vandaag de uitbreiding van DIGIYLYFE: Senegal · Petite Côte en Dakar; Frankrijk · Dordognevallei en Bordeaux; Verenigde Staten · Miami. Kies uw gebied, daarna uw behoefte en zone.',path:'Land → Gebied → Zone → Behoefte → Professional → OPENEN',dordogneTitle:'DIGIY PÉRIGORD · DORDOGNEVALLEI',dordogneZones:'Sarlat-la-Canéda · Périgord · Dordognevallei',aria:'DIGIYLYFE van lokaal naar de wereld'},
      ar:{title:'DIGIYLYFE · من المحلي إلى العالم',lead:'CORE واحد. مناطق مختلفة. والمهني يبقى محليًا.',intro:'تُظهر خمس بوابات حقيقية اليوم توسع DIGIYLYFE: السنغال · Petite Côte وداكار؛ فرنسا · وادي دوردوني وبوردو؛ الولايات المتحدة · ميامي. اختر الإقليم ثم حاجتك والمنطقة المحلية.',path:'البلد ← الإقليم ← المنطقة ← الحاجة ← المهني ← فتح',dordogneTitle:'DIGIY PÉRIGORD · وادي دوردوني',dordogneZones:'Sarlat-la-Canéda · Périgord · وادي دوردوني',aria:'DIGIYLYFE من المحلي إلى العالم'}
    };
  ...
  function installSitePricingTiers(){
    ...
    function refresh(){
      ...
      /* price supplied exclusively by digiy-membership-country-v1.js */
  ...
  function installPostPaymentCardButton(){
    ...
    function refresh(){
      ...
      var selectedCountry=(new URLSearchParams(location.search).get('country')||localStorage.getItem('digiy_country')||'sn').toLowerCase();
