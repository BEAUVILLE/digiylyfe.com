...
block='''      <strong data-i18n="claimWorld">Une source. Tous les canaux. Tous les continents.</strong>
      <div class="globalDirection" id="digiyGlobalDirection" aria-label="Direction internationale DIGIYLYFE">
        ...
        <div class="globalCountries">
          ...
          <span class="globalCountry future">🇵🇹 <span data-i18n="globalPortugal">Portugal</span> <b class="globalStatus" data-i18n="globalComing">À VENIR</b></span>
...
add={
'fr':{'globalContinents':'AFRIQUE · EUROPE · AMÉRIQUE · MOYEN-ORIENT · ASIE','globalLead':'Sénégal et France déjà actifs. Le monde suit progressivement.','globalSenegal':'Sénégal','globalFrance':'France','globalIvory':'Côte d’Ivoire','globalPortugal':'Portugal','globalUae':'Émirats arabes unis','globalUsa':'États-Unis','globalActive':'ACTIF','globalComing':'À VENIR'},
'en':{'globalContinents':'AFRICA · EUROPE · AMERICA · MIDDLE EAST · ASIA','globalLead':'Senegal and France are already active. The world follows progressively.','globalSenegal':'Senegal','globalFrance':'France','globalIvory':'Côte d’Ivoire','globalPortugal':'Portugal','globalUae':'United Arab Emirates','globalUsa':'United States','globalActive':'ACTIVE','globalComing':'COMING'},
'es':{'globalContinents':'ÁFRICA · EUROPA · AMÉRICA · ORIENTE MEDIO · ASIA','globalLead':'Senegal y Francia ya están activos. El mundo sigue progresivamente.','globalSenegal':'Senegal','globalFrance':'Francia','globalIvory':'Costa de Marfil','globalPortugal':'Portugal','globalUae':'Emiratos Árabes Unidos','globalUsa':'Estados Unidos','globalActive':'ACTIVO','globalComing':'PRÓXIMAMENTE'},
'pt':{'globalContinents':'ÁFRICA · EUROPA · AMÉRICA · MÉDIO ORIENTE · ÁSIA','globalLead':'Senegal e França já estão ativos. O mundo segue progressivamente.','globalSenegal':'Senegal','globalFrance':'França','globalIvory':'Costa do Marfim','globalPortugal':'Portugal','globalUae':'Emirados Árabes Unidos','globalUsa':'Estados Unidos','globalActive':'ATIVO','globalComing':'EM BREVE'},
'it':{'globalContinents':'AFRICA · EUROPA · AMERICA · MEDIO ORIENTE · ASIA','globalLead':'Senegal e Francia sono già attivi. Il mondo segue progressivamente.','globalSenegal':'Senegal','globalFrance':'Francia','globalIvory':'Costa d’Avorio','globalPortugal':'Portogallo','globalUae':'Emirati Arabi Uniti','globalUsa':'Stati Uniti','globalActive':'ATTIVO','globalComing':'IN ARRIVO'},
'de':{'globalContinents':'AFRIKA · EUROPA · AMERIKA · NAHER OSTEN · ASIEN','globalLead':'Senegal und Frankreich sind bereits aktiv. Die Welt folgt schrittweise.','globalSenegal':'Senegal','globalFrance':'Frankreich','globalIvory':'Elfenbeinküste','globalPortugal':'Portugal','globalUae':'Vereinigte Arabische Emirate','globalUsa':'Vereinigte Staaten','globalActive':'AKTIV','globalComing':'DEMNÄCHST'},
'nl':{'globalContinents':'AFRIKA · EUROPA · AMERIKA · MIDDEN-OOSTEN · AZIË','globalLead':'Senegal en Frankrijk zijn al actief. De wereld volgt stap voor stap.','globalSenegal':'Senegal','globalFrance':'Frankrijk','globalIvory':'Ivoorkust','globalPortugal':'Portugal','globalUae':'Verenigde Arabische Emiraten','globalUsa':'Verenigde Staten','globalActive':'ACTIEF','globalComing':'BINNENKORT'},
'ar':{'globalContinents':'أفريقيا · أوروبا · أمريكا · الشرق الأوسط · آسيا','globalLead':'السنغال وفرنسا نشطتان بالفعل. ويتوسع العالم تدريجيًا.','globalSenegal':'السنغال','globalFrance':'فرنسا','globalIvory':'ساحل العاج','globalPortugal':'البرتغال','globalUae':'الإمارات العربية المتحدة','globalUsa':'الولايات المتحدة','globalActive':'نشط','globalComing':'قريبًا'}
}
