...
usa_link_pattern = r'href="https://digiylyfe\.com/carte-gratuite\.html\?country=us(?:&amp;|&)lang=en(?:&amp;|&)territory=miami">🇺🇸 <span data-i18n="globalUsa">'
usa_link_replacement = 'href="https://digiylyfe.com/miami.html?lang=en">🇺🇸 <span data-i18n="globalUsa">'
s, n = re.subn(usa_link_pattern, usa_link_replacement, s, count=1)
if n != 1:
    raise SystemExit(f'INDEX: USA direct-card link replacement count={n}')
...
# Language-aware label for the new primary guide CTA. Numeric price truth stays visible in every language.
